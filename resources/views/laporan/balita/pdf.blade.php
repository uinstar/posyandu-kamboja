...
<div class="header" style="display: table; width: 100%; border-bottom: 2px solid #000; padding-bottom: 10px; margin-bottom: 20px;">
    ...
    <div style="display: table-cell; width: 60%; text-align: center; vertical-align: middle; font-family: sans-serif;">
        <div style="font-size: 20px; font-weight: bold; text-transform: uppercase;">Laporan Pemeriksaan Balita Posyandu Kamboja</div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Berat Badan</th><th>Tinggi Badan</th><th>Lingkar Kepala (LIKA)</th><th>Lingkar Lengan (LILA)</th>
